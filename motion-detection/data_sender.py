...
async def main():
    ...
    await data_sender.start_server()
    
    # Start sender task
    sender_task = asyncio.create_task(data_sender._send_to_clients())
    ...
    try:
        ...
        while True:
            ...
            # Send data to Unity
            await data_sender.send_data(landmarks, exercise_states, camera.get_fps())
